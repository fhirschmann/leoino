// clang-format off
	...
	*/
	...
	constexpr uint16_t smartSeekCoalesceMs = 450;                 // Quiet period after the last Smart navigation press; batches rapid track skips/seeks into one decoder reconnect
