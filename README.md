...
| **Selectable UI themes** (menu → 🎨): switch the whole interface between the default **Cyberpunk** look and a bright, rounded, playful **Kids** theme. Themes are a pure client-side CSS-variable swap (zero extra load on the ESP32 — the device still serves one static page) and the choice is remembered per browser in `localStorage` | [`6960166`](../../commit/6960166) |
